...
public class CustomMarkerActivity extends Activity implements OnMarkerClickListener,
	...
	private LatLng latlng = new LatLng(117.309658, 31.793093);
	...
	/*private void showNormalDialog(){
        *//* @setIcon 设置对话框图标
		...
		final AlertDialog.Builder normalDialog =
				new AlertDialog.Builder(CustomMarkerActivity.this);
		normalDialog.setIcon(R.drawable.coordinates);
		normalDialog.setTitle("查看设备详情");
		normalDialog.setMessage("是否查看设备详情?");
		normalDialog.setPositiveButton("确定",
				new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialog, int which) {
						Bundle bundle = new Bundle();
						bundle.putString("select", "shanghainijiang");
						Intent intent = new Intent(CustomMarkerActivity.this, ListTableActivity.class);
...
/*
		...
		marker.setPosition(Constants.CHENGDU);
		...
		MarkerOptions markerOption1 = new MarkerOptions().anchor(0.5f, 0.5f)
				.position(Constants.ANHUIHEFEIBAOHE).title("安徽省合肥市包河区")
				.snippet("包河区:117.309658,31.793093").icons(giflist)
	...
	public void jumpPoint(final Marker marker) {
		...
		Point startPoint = proj.toScreenLocation(Constants.CHENGDU);
