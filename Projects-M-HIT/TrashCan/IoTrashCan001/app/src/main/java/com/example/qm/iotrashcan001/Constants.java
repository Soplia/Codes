...
public class Constants {
	...
	public static final LatLng SHANGHAI = new LatLng(31.306624, 121.305546);// 上海市设备1
	...
	public static final LatLng NIJIANGSHEBEI = new LatLng(34.7466, 113.625367);// 郑州市经纬度
	public static final LatLng ANHUIHEFEIBAOHE = new LatLng(31.7930, 117.3096);//
}
