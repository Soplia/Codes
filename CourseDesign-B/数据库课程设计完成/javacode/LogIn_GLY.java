import java.sql.*;
public class LogIn_GLY extends javax.swing.JFrame 
{
    ...
    {    
        ...
        try
        {
        	String sql="select GLY_Password from GuanLiYuan_JC where GLY_No like ?";
        	...
        	while(set.next())
        	{
        		temp_password=set.getInt("GLY_Password");
        	}
        	if(Integer.parseInt(temp_pass)==temp_password)
        	{
        		
        		gly_Total=new GLY_Total();
        		gly_Total.setVisible(true);
        	}
        }
        catch(Exception e)
        {
